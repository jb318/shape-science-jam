...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamProUser_BeginAuthSession_Statics::NewProp_SteamID = { "SteamID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventBeginAuthSession_Parms, SteamID), Z_Construct_UScriptStruct_FSteamID, METADATA_PARAMS(0, nullptr) }; // 664632778
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamProUser_EndAuthSession_Statics::NewProp_SteamID = { "SteamID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventEndAuthSession_Parms, SteamID), Z_Construct_UScriptStruct_FSteamID, METADATA_PARAMS(0, nullptr) }; // 664632778
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USteamProUser_GetAvailableVoice_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventGetAvailableVoice_Parms, ReturnValue), Z_Construct_UEnum_SteamCorePro_ESteamVoiceResult, METADATA_PARAMS(0, nullptr) }; // 3920524505
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamProUser_GetSteamID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventGetSteamID_Parms, ReturnValue), Z_Construct_UScriptStruct_FSteamID, METADATA_PARAMS(0, nullptr) }; // 664632778
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamProUser_GetSteamID_Pure_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventGetSteamID_Pure_Parms, ReturnValue), Z_Construct_UScriptStruct_FSteamID, METADATA_PARAMS(0, nullptr) }; // 664632778
...
// Begin Class USteamProUser Function GetSteamIDAsString
struct Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics
{
	struct SteamProUser_eventGetSteamIDAsString_Parms
	{
		FString ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "/**\n\x09* Gets the Steam ID of the account currently logged into the Steam client. This is commonly called the 'current user', or 'local user'.\n\x09*\n\x09* A Steam ID is a unique identifier for a Steam accounts, Steam groups, Lobbies and Chat rooms, and used to differentiate users in all parts of the Steamworks API.\n\x09*/" },
#endif
		{ "DisplayName", "Get SteamId as String" },
		{ "ModuleRelativePath", "Public/SteamUser/SteamUser.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Gets the Steam ID of the account currently logged into the Steam client. This is commonly called the 'current user', or 'local user'.\n\nA Steam ID is a unique identifier for a Steam accounts, Steam groups, Lobbies and Chat rooms, and used to differentiate users in all parts of the Steamworks API." },
#endif
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventGetSteamIDAsString_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamProUser, nullptr, "GetSteamIDAsString", nullptr, nullptr, Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::PropPointers), sizeof(Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::SteamProUser_eventGetSteamIDAsString_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::Function_MetaDataParams), Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::SteamProUser_eventGetSteamIDAsString_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_USteamProUser_GetSteamIDAsString()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_USteamProUser_GetSteamIDAsString_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(USteamProUser::execGetSteamIDAsString)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(FString*)Z_Param__Result=USteamProUser::GetSteamIDAsString();
	P_NATIVE_END;
}
// End Class USteamProUser Function GetSteamIDAsString
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_USteamProUser_GetVoice_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_USteamProUser_GetVoice_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamProUser_eventGetVoice_Parms, ReturnValue), Z_Construct_UEnum_SteamCorePro_ESteamVoiceResult, METADATA_PARAMS(0, nullptr) }; // 3920524505
...
void USteamProUser::StaticRegisterNativesUSteamProUser()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetSteamIDAsString", &USteamProUser::execGetSteamIDAsString },
...
struct Z_Construct_UClass_USteamProUser_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamProUser_AdvertiseGame, "AdvertiseGame" }, // 1487604741
		{ &Z_Construct_UFunction_USteamProUser_BeginAuthSession, "BeginAuthSession" }, // 2848209829
		{ &Z_Construct_UFunction_USteamProUser_BIsBehindNAT, "BIsBehindNAT" }, // 2954123670
		{ &Z_Construct_UFunction_USteamProUser_BIsPhoneIdentifying, "BIsPhoneIdentifying" }, // 942110773
		{ &Z_Construct_UFunction_USteamProUser_BIsPhoneRequiringVerification, "BIsPhoneRequiringVerification" }, // 3739643715
		{ &Z_Construct_UFunction_USteamProUser_BIsPhoneVerified, "BIsPhoneVerified" }, // 3940704779
		{ &Z_Construct_UFunction_USteamProUser_BIsTwoFactorEnabled, "BIsTwoFactorEnabled" }, // 3229875410
		{ &Z_Construct_UFunction_USteamProUser_BLoggedOn, "BLoggedOn" }, // 4271392283
		{ &Z_Construct_UFunction_USteamProUser_CancelAuthTicket, "CancelAuthTicket" }, // 3553796695
		{ &Z_Construct_UFunction_USteamProUser_DecompressVoice, "DecompressVoice" }, // 388820590
		{ &Z_Construct_UFunction_USteamProUser_EndAuthSession, "EndAuthSession" }, // 3649857320
		{ &Z_Construct_UFunction_USteamProUser_GetAuthSessionTicket, "GetAuthSessionTicket" }, // 2403067982
		{ &Z_Construct_UFunction_USteamProUser_GetAuthTicketForWebApi, "GetAuthTicketForWebApi" }, // 2615531765
		{ &Z_Construct_UFunction_USteamProUser_GetAvailableVoice, "GetAvailableVoice" }, // 1806507056
		{ &Z_Construct_UFunction_USteamProUser_GetEncryptedAppTicket, "GetEncryptedAppTicket" }, // 1918136532
		{ &Z_Construct_UFunction_USteamProUser_GetGameBadgeLevel, "GetGameBadgeLevel" }, // 2908508308
		{ &Z_Construct_UFunction_USteamProUser_GetPlayerSteamLevel, "GetPlayerSteamLevel" }, // 1873268538
		{ &Z_Construct_UFunction_USteamProUser_GetSteamID, "GetSteamID" }, // 2301885732
		{ &Z_Construct_UFunction_USteamProUser_GetSteamID_Pure, "GetSteamID_Pure" }, // 850732366
		{ &Z_Construct_UFunction_USteamProUser_GetSteamIDAsString, "GetSteamIDAsString" }, // 1167856624
		{ &Z_Construct_UFunction_USteamProUser_GetSteamUser, "GetSteamUser" }, // 1892577143
		{ &Z_Construct_UFunction_USteamProUser_GetVoice, "GetVoice" }, // 1287932201
		{ &Z_Construct_UFunction_USteamProUser_GetVoiceOptimalSampleRate, "GetVoiceOptimalSampleRate" }, // 4002418967
		{ &Z_Construct_UFunction_USteamProUser_RequestEncryptedAppTicket, "RequestEncryptedAppTicket" }, // 1205605898
		{ &Z_Construct_UFunction_USteamProUser_RequestStoreAuthURL, "RequestStoreAuthURL" }, // 1660984140
		{ &Z_Construct_UFunction_USteamProUser_StartVoiceRecording, "StartVoiceRecording" }, // 509068646
		{ &Z_Construct_UFunction_USteamProUser_StopVoiceRecording, "StopVoiceRecording" }, // 3984338405
		{ &Z_Construct_UFunction_USteamProUser_UserHasLicenseForApp, "UserHasLicenseForApp" }, // 3743754861
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamUser_SteamUser_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USteamProUser, USteamProUser::StaticClass, TEXT("USteamProUser"), &Z_Registration_Info_UClass_USteamProUser, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamProUser), 1485638004U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamUser_SteamUser_h_819540467(TEXT("/Script/SteamCorePro"),
	Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamUser_SteamUser_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamUser_SteamUser_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
