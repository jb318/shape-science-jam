...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESteamVRScreenshotType_StaticEnum, TEXT("ESteamVRScreenshotType"), &Z_Registration_Info_UEnum_ESteamVRScreenshotType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 669842126U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FScreenshotHandle::StaticStruct, Z_Construct_UScriptStruct_FScreenshotHandle_Statics::NewStructOps, TEXT("ScreenshotHandle"), &Z_Registration_Info_UScriptStruct_ScreenshotHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenshotHandle), 1394851946U) },
		{ FScreenshotReady::StaticStruct, Z_Construct_UScriptStruct_FScreenshotReady_Statics::NewStructOps, TEXT("ScreenshotReady"), &Z_Registration_Info_UScriptStruct_ScreenshotReady, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenshotReady), 7329189U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamScreenshots_SteamScreenshotsTypes_h_1864291220(TEXT("/Script/SteamCorePro"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_JB_Unreal_Projects_shape_science_jam_Plugins_SteamCorePro_5_4_Source_SteamCorePro_Public_SteamScreenshots_SteamScreenshotsTypes_h_Statics::EnumInfo));
// End Registration
