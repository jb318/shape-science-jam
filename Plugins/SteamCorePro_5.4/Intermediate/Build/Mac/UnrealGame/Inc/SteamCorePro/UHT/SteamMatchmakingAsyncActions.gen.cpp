...
STEAMCOREPRO_API UClass* Z_Construct_UClass_USteamCoreProCreateSessionExtra();
STEAMCOREPRO_API UClass* Z_Construct_UClass_USteamCoreProCreateSessionExtra_NoRegister();
...
STEAMCOREPRO_API UClass* Z_Construct_UClass_USteamCoreProJoinSession();
STEAMCOREPRO_API UClass* Z_Construct_UClass_USteamCoreProJoinSession_NoRegister();
...
STEAMCOREPRO_API UFunction* Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature();
...
// Begin Delegate FJoinSteamCoreSessionDelegate
struct Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics
{
	struct _Script_SteamCorePro_eventJoinSteamCoreSessionDelegate_Parms
	{
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::NewProp_JoinFailReason = { "JoinFailReason", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_SteamCorePro_eventJoinSteamCoreSessionDelegate_Parms, JoinFailReason), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_JoinFailReason_MetaData), NewProp_JoinFailReason_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::NewProp_JoinFailReason,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SteamCorePro, nullptr, "JoinSteamCoreSessionDelegate__DelegateSignature", nullptr, nullptr, Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::_Script_SteamCorePro_eventJoinSteamCoreSessionDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::_Script_SteamCorePro_eventJoinSteamCoreSessionDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FJoinSteamCoreSessionDelegate_DelegateWrapper(const FMulticastScriptDelegate& JoinSteamCoreSessionDelegate, const FString& JoinFailReason)
{
	struct _Script_SteamCorePro_eventJoinSteamCoreSessionDelegate_Parms
	{
		FString JoinFailReason;
	};
	_Script_SteamCorePro_eventJoinSteamCoreSessionDelegate_Parms Parms;
	Parms.JoinFailReason=JoinFailReason;
	JoinSteamCoreSessionDelegate.ProcessMulticastDelegate<UObject>(&Parms);
}
// End Delegate FJoinSteamCoreSessionDelegate
...
struct Z_Construct_UClass_USteamCoreProMatchmakingAsyncActionCreateLobby_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreProMatchmakingAsyncActionCreateLobby_CreateLobbyAsync, "CreateLobbyAsync" }, // 4180742037
...
// Begin Class USteamCoreProCreateSessionExtra Function CreateSteamCoreProSessionExtra
struct Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics
{
	struct SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms
	{
		UObject* WorldContextObject;
		...
		USteamCoreProCreateSessionExtra* ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "DisplayName", "Create SteamCore PRO Session (Extra)" },
		{ "ModuleRelativePath", "Public/SteamMatchmaking/SteamMatchmakingAsyncActions.h" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionSettings_ValueProp = { "SessionSettings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FSteamSessionSetting, METADATA_PARAMS(0, nullptr) }; // 3078998749
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionSettings_Key_KeyProp = { "SessionSettings_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionSettings = { "SessionSettings", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms, SessionSettings), EMapPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 3078998749
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionPassword = { "SessionPassword", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms, SessionPassword), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionName = { "SessionName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms, SessionName), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_MaxPlayers = { "MaxPlayers", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms, MaxPlayers), METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLAN_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bUseLAN = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLAN = { "bUseLAN", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLAN_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowInvites_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bAllowInvites = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowInvites = { "bAllowInvites", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowInvites_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesPresence_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bUsesPresence = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesPresence = { "bUsesPresence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesPresence_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresence_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bAllowJoinViaPresence = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresence = { "bAllowJoinViaPresence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresence_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresenceFriendsOnly_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bAllowJoinViaPresenceFriendsOnly = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresenceFriendsOnly = { "bAllowJoinViaPresenceFriendsOnly", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresenceFriendsOnly_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAntiCheatProtected_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bAntiCheatProtected = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAntiCheatProtected = { "bAntiCheatProtected", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAntiCheatProtected_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesStats_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bUsesStats = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesStats = { "bUsesStats", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesStats_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bShouldAdvertise_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bShouldAdvertise = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bShouldAdvertise = { "bShouldAdvertise", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bShouldAdvertise_SetBit, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLobbiesVoiceChatIfAvailable_SetBit(void* Obj)
{
	((SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms*)Obj)->bUseLobbiesVoiceChatIfAvailable = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLobbiesVoiceChatIfAvailable = { "bUseLobbiesVoiceChatIfAvailable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLobbiesVoiceChatIfAvailable_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms, ReturnValue), Z_Construct_UClass_USteamCoreProCreateSessionExtra_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_WorldContextObject,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionSettings_ValueProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionSettings_Key_KeyProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionSettings,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionPassword,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_SessionName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_MaxPlayers,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLAN,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowInvites,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesPresence,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresence,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAllowJoinViaPresenceFriendsOnly,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bAntiCheatProtected,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUsesStats,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bShouldAdvertise,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_bUseLobbiesVoiceChatIfAvailable,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamCoreProCreateSessionExtra, nullptr, "CreateSteamCoreProSessionExtra", nullptr, nullptr, Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::PropPointers), sizeof(Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::Function_MetaDataParams), Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::SteamCoreProCreateSessionExtra_eventCreateSteamCoreProSessionExtra_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(USteamCoreProCreateSessionExtra::execCreateSteamCoreProSessionExtra)
{
	P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(USteamCoreProCreateSessionExtra**)Z_Param__Result=USteamCoreProCreateSessionExtra::CreateSteamCoreProSessionExtra(Z_Param_WorldContextObject,Z_Param_SessionSettings,Z_Param_SessionPassword,Z_Param_SessionName,Z_Param_MaxPlayers,Z_Param_bUseLAN,Z_Param_bAllowInvites,Z_Param_bUsesPresence,Z_Param_bAllowJoinViaPresence,Z_Param_bAllowJoinViaPresenceFriendsOnly,Z_Param_bAntiCheatProtected,Z_Param_bUsesStats,Z_Param_bShouldAdvertise,Z_Param_bUseLobbiesVoiceChatIfAvailable);
	P_NATIVE_END;
}
// End Class USteamCoreProCreateSessionExtra Function CreateSteamCoreProSessionExtra

// Begin Class USteamCoreProCreateSessionExtra
void USteamCoreProCreateSessionExtra::StaticRegisterNativesUSteamCoreProCreateSessionExtra()
{
	UClass* Class = USteamCoreProCreateSessionExtra::StaticClass();
	static const FNameNativePtrPair Funcs[] = {
		{ "CreateSteamCoreProSessionExtra", &USteamCoreProCreateSessionExtra::execCreateSteamCoreProSessionExtra },
	};
	FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
}
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(USteamCoreProCreateSessionExtra);
UClass* Z_Construct_UClass_USteamCoreProCreateSessionExtra_NoRegister()
{
	return USteamCoreProCreateSessionExtra::StaticClass();
}
struct Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		{ "Comment", "// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //\n//\x09\x09USteamCoreProCreateSessionExtra\n// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //\n" },
		{ "IncludePath", "SteamMatchmaking/SteamMatchmakingAsyncActions.h" },
		{ "ModuleRelativePath", "Public/SteamMatchmaking/SteamMatchmakingAsyncActions.h" },
		{ "ToolTip", "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n              USteamCoreProCreateSessionExtra\n~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~" },
	};
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreProCreateSessionExtra_CreateSteamCoreProSessionExtra, "CreateSteamCoreProSessionExtra" }, // 96295034
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<USteamCoreProCreateSessionExtra>::IsAbstract,
	};
	static const UECodeGen_Private::FClassParams ClassParams;
};
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamCoreProCreateSessionExtra, OnSuccess), Z_Construct_UDelegateFunction_Engine_EmptyOnlineDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnSuccess_MetaData), NewProp_OnSuccess_MetaData) }; // 2328757345
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::NewProp_OnFailure = { "OnFailure", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamCoreProCreateSessionExtra, OnFailure), Z_Construct_UDelegateFunction_Engine_EmptyOnlineDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnFailure_MetaData), NewProp_OnFailure_MetaData) }; // 2328757345
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::NewProp_OnSuccess,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::NewProp_OnFailure,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_USteamCoreProAsyncAction,
	(UObject* (*)())Z_Construct_UPackage__Script_SteamCorePro,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::ClassParams = {
	&USteamCoreProCreateSessionExtra::StaticClass,
	nullptr,
	&StaticCppClassTypeInfo,
	DependentSingletons,
	FuncInfo,
	Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	UE_ARRAY_COUNT(FuncInfo),
	UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::PropPointers),
	0,
	0x009000A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::Class_MetaDataParams), Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_USteamCoreProCreateSessionExtra()
{
	if (!Z_Registration_Info_UClass_USteamCoreProCreateSessionExtra.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_USteamCoreProCreateSessionExtra.OuterSingleton, Z_Construct_UClass_USteamCoreProCreateSessionExtra_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_USteamCoreProCreateSessionExtra.OuterSingleton;
}
template<> STEAMCOREPRO_API UClass* StaticClass<USteamCoreProCreateSessionExtra>()
{
	return USteamCoreProCreateSessionExtra::StaticClass();
}
DEFINE_VTABLE_PTR_HELPER_CTOR(USteamCoreProCreateSessionExtra);
USteamCoreProCreateSessionExtra::~USteamCoreProCreateSessionExtra() {}
// End Class USteamCoreProCreateSessionExtra
...
struct Z_Construct_UFunction_USteamCoreProCreateSession_CreateSteamCoreProSession_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "CPP_Default_MaxPlayers", "5" },
		{ "CPP_Default_SessionName", "SteamCoreProSession" },
		{ "DisplayName", "Create SteamCore PRO Session" },
		{ "ModuleRelativePath", "Public/SteamMatchmaking/SteamMatchmakingAsyncActions.h" },
		{ "ToolTip", "Creates an online session\n\nAutomatically detects if we're running a dedicated or listen server\n\nListen servers will create a Lobby Session, use \"FindSteamCoreProSession\" to find Listen Servers\n\n   @param SessionPassword                                             Optional session password\n   @param SessionName                                                 Name of our session\n   @param MaxPlayers                                                  Number of public connections\n   @param bUseLAN                                                             Used for LAN server" },
		{ "WorldContext", "WorldContextObject" },
	};
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_USteamCoreProCreateSession_CreateSteamCoreProSession_Statics::NewProp_SessionSettings = { "SessionSettings", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSession_eventCreateSteamCoreProSession_Parms, SessionSettings), EMapPropertyFlags::None, METADATA_PARAMS(0, nullptr) }; // 3078998749
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamCoreProCreateSession_CreateSteamCoreProSession_Statics::NewProp_SessionPassword = { "SessionPassword", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProCreateSession_eventCreateSteamCoreProSession_Parms, SessionPassword), METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamCoreProCreateSession_CreateSteamCoreProSession_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProCreateSession_CreateSteamCoreProSession_Statics::NewProp_SessionPassword,
...
struct Z_Construct_UClass_USteamCoreProCreateSession_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreProCreateSession_CreateSteamCoreProSession, "CreateSteamCoreProSession" }, // 4057570353
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_SteamCorePro_FindSteamSessionsResultDelegate__DelegateSignature_Statics::NewProp_Results_Inner = { "Results", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FSteamSessionResult, METADATA_PARAMS(0, nullptr) }; // 4087666314
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_SteamCorePro_FindSteamSessionsResultDelegate__DelegateSignature_Statics::NewProp_Results = { "Results", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_SteamCorePro_eventFindSteamSessionsResultDelegate_Parms, Results), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Results_MetaData), NewProp_Results_MetaData) }; // 4087666314
...
struct Z_Construct_UClass_USteamCoreProFindSession_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreProFindSession_FindSteamCoreProSessions, "FindSteamCoreProSessions" }, // 2453676428
...
// Begin Class USteamCoreProJoinSession Function JoinSteamCoreProSession
struct Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics
{
	struct SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms
	{
		UObject* WorldContextObject;
		APlayerController* PlayerController;
		FString SessionPassword;
		FBlueprintSessionResult SearchResult;
		USteamCoreProJoinSession* ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "BlueprintInternalUseOnly", "true" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_PlayerController = { "PlayerController", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms, PlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_SessionPassword = { "SessionPassword", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms, SessionPassword), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_SearchResult = { "SearchResult", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms, SearchResult), Z_Construct_UScriptStruct_FBlueprintSessionResult, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SearchResult_MetaData), NewProp_SearchResult_MetaData) }; // 1307808723
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms, ReturnValue), Z_Construct_UClass_USteamCoreProJoinSession_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_WorldContextObject,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_PlayerController,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_SessionPassword,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_SearchResult,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USteamCoreProJoinSession, nullptr, "JoinSteamCoreProSession", nullptr, nullptr, Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::PropPointers), sizeof(Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::Function_MetaDataParams), Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::SteamCoreProJoinSession_eventJoinSteamCoreProSession_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(USteamCoreProJoinSession::execJoinSteamCoreProSession)
{
	P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(USteamCoreProJoinSession**)Z_Param__Result=USteamCoreProJoinSession::JoinSteamCoreProSession(Z_Param_WorldContextObject,Z_Param_PlayerController,Z_Param_SessionPassword,Z_Param_Out_SearchResult);
	P_NATIVE_END;
}
// End Class USteamCoreProJoinSession Function JoinSteamCoreProSession

// Begin Class USteamCoreProJoinSession
void USteamCoreProJoinSession::StaticRegisterNativesUSteamCoreProJoinSession()
{
	UClass* Class = USteamCoreProJoinSession::StaticClass();
	static const FNameNativePtrPair Funcs[] = {
		{ "JoinSteamCoreProSession", &USteamCoreProJoinSession::execJoinSteamCoreProSession },
	};
	FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
}
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(USteamCoreProJoinSession);
UClass* Z_Construct_UClass_USteamCoreProJoinSession_NoRegister()
{
	return USteamCoreProJoinSession::StaticClass();
}
struct Z_Construct_UClass_USteamCoreProJoinSession_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		{ "Comment", "// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //\n//\x09\x09USteamCoreProJoinSession\n// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //\n" },
		{ "IncludePath", "SteamMatchmaking/SteamMatchmakingAsyncActions.h" },
		{ "ModuleRelativePath", "Public/SteamMatchmaking/SteamMatchmakingAsyncActions.h" },
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreProJoinSession_JoinSteamCoreProSession, "JoinSteamCoreProSession" }, // 1887104270
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<USteamCoreProJoinSession>::IsAbstract,
	};
	static const UECodeGen_Private::FClassParams ClassParams;
};
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USteamCoreProJoinSession_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamCoreProJoinSession, OnSuccess), Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnSuccess_MetaData), NewProp_OnSuccess_MetaData) }; // 1246589721
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USteamCoreProJoinSession_Statics::NewProp_OnFailure = { "OnFailure", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamCoreProJoinSession, OnFailure), Z_Construct_UDelegateFunction_SteamCorePro_JoinSteamCoreSessionDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnFailure_MetaData), NewProp_OnFailure_MetaData) }; // 1246589721
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USteamCoreProJoinSession_Statics::NewProp_m_WorldContextObject = { "m_WorldContextObject", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamCoreProJoinSession, m_WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_m_WorldContextObject_MetaData), NewProp_m_WorldContextObject_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USteamCoreProJoinSession_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USteamCoreProJoinSession_Statics::NewProp_OnSuccess,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USteamCoreProJoinSession_Statics::NewProp_OnFailure,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USteamCoreProJoinSession_Statics::NewProp_m_WorldContextObject,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProJoinSession_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_USteamCoreProJoinSession_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_USteamCoreProAsyncAction,
	(UObject* (*)())Z_Construct_UPackage__Script_SteamCorePro,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProJoinSession_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_USteamCoreProJoinSession_Statics::ClassParams = {
	&USteamCoreProJoinSession::StaticClass,
	nullptr,
	&StaticCppClassTypeInfo,
	DependentSingletons,
	FuncInfo,
	Z_Construct_UClass_USteamCoreProJoinSession_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	UE_ARRAY_COUNT(FuncInfo),
	UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProJoinSession_Statics::PropPointers),
	0,
	0x008000A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_USteamCoreProJoinSession_Statics::Class_MetaDataParams), Z_Construct_UClass_USteamCoreProJoinSession_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_USteamCoreProJoinSession()
{
	if (!Z_Registration_Info_UClass_USteamCoreProJoinSession.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_USteamCoreProJoinSession.OuterSingleton, Z_Construct_UClass_USteamCoreProJoinSession_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_USteamCoreProJoinSession.OuterSingleton;
}
template<> STEAMCOREPRO_API UClass* StaticClass<USteamCoreProJoinSession>()
{
	return USteamCoreProJoinSession::StaticClass();
}
DEFINE_VTABLE_PTR_HELPER_CTOR(USteamCoreProJoinSession);
USteamCoreProJoinSession::~USteamCoreProJoinSession() {}
// End Class USteamCoreProJoinSession
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USteamCoreProUpdateSession_UpdateSteamCoreProSession_Statics::NewProp_Settings_ValueProp = { "Settings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FSteamSessionSetting, METADATA_PARAMS(0, nullptr) }; // 3078998749
...
struct Z_Construct_UClass_USteamCoreProUpdateSession_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USteamCoreProUpdateSession_UpdateSteamCoreProSession, "UpdateSteamCoreProSession" }, // 958759748
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USteamCoreProUpdateSession_Statics::NewProp_m_WorldContextObject = { "m_WorldContextObject", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(USteamCoreProUpdateSession, m_WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_m_WorldContextObject_MetaData), NewProp_m_WorldContextObject_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USteamCoreProUpdateSession_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USteamCoreProUpdateSession_Statics::NewProp_m_WorldContextObject,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamMatchmaking_SteamMatchmakingAsyncActions_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		...
		{ Z_Construct_UClass_USteamCoreProCreateSessionExtra, USteamCoreProCreateSessionExtra::StaticClass, TEXT("USteamCoreProCreateSessionExtra"), &Z_Registration_Info_UClass_USteamCoreProCreateSessionExtra, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreProCreateSessionExtra), 2474208710U) },
		{ Z_Construct_UClass_USteamCoreProCreateSession, USteamCoreProCreateSession::StaticClass, TEXT("USteamCoreProCreateSession"), &Z_Registration_Info_UClass_USteamCoreProCreateSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreProCreateSession), 3602005077U) },
		{ Z_Construct_UClass_USteamCoreProFindSession, USteamCoreProFindSession::StaticClass, TEXT("USteamCoreProFindSession"), &Z_Registration_Info_UClass_USteamCoreProFindSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreProFindSession), 3513589793U) },
		{ Z_Construct_UClass_USteamCoreProJoinSession, USteamCoreProJoinSession::StaticClass, TEXT("USteamCoreProJoinSession"), &Z_Registration_Info_UClass_USteamCoreProJoinSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreProJoinSession), 1207284270U) },
		...
		{ Z_Construct_UClass_USteamCoreProUpdateSession, USteamCoreProUpdateSession::StaticClass, TEXT("USteamCoreProUpdateSession"), &Z_Registration_Info_UClass_USteamCoreProUpdateSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreProUpdateSession), 2437409242U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamMatchmaking_SteamMatchmakingAsyncActions_h_2916598445(TEXT("/Script/SteamCorePro"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamMatchmaking_SteamMatchmakingAsyncActions_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamMatchmaking_SteamMatchmakingAsyncActions_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
