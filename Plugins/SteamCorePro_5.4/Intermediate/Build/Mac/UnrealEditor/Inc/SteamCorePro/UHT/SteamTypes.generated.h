...
// IWYU pragma: private, include "SteamCorePro/SteamTypes.h"
#include "UObject/ObjectMacros.h"
#include "UObject/ScriptMacros.h"

PRAGMA_DISABLE_DEPRECATION_WARNINGS
#ifdef STEAMCOREPRO_SteamTypes_generated_h
#error "SteamTypes.generated.h already included, missing '#pragma once' in SteamTypes.h"
#endif
#define STEAMCOREPRO_SteamTypes_generated_h

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_753_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamID_Statics; \
	static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamID>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_799_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamGameID_Statics; \
	static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamGameID>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_838_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamUGCHandle_Statics; \
	static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamUGCHandle>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_863_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamInventoryUpdateHandle_Statics; \
	static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamInventoryUpdateHandle>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_949_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamNetworkingIdentity_Statics; \
	static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamNetworkingIdentity>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_969_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamTicketHandle_Statics; \
	static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamTicketHandle>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_995_GENERATED_BODY \
...
template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FValidateAuthTicketResponse>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_1023_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FPublishedFileID_Statics; \
	STEAMCOREPRO_API static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FPublishedFileID>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_1048_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FRemoteStorageSubscribePublishedFileResult_Statics; \
	STEAMCOREPRO_API static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FRemoteStorageSubscribePublishedFileResult>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_1075_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamSessionSearchSetting_Statics; \
	STEAMCOREPRO_API static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamSessionSearchSetting>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_1108_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSteamSessionResult_Statics; \
	STEAMCOREPRO_API static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FSteamSessionResult>();

#define FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h_1134_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FPartyBeaconID_Statics; \
	STEAMCOREPRO_API static class UScriptStruct* StaticStruct();


template<> STEAMCOREPRO_API UScriptStruct* StaticStruct<struct FPartyBeaconID>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCorePro_Public_SteamCorePro_SteamTypes_h
...
#define FOREACH_ENUM_ESTEAMCORENETWORKINGIDENTITYTYPE(op) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_Invalid) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_SteamID) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_XboxPairwiseID) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_SonyPSN) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_GoogleStadia) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_IPAddress) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_GenericString) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_GenericBytes) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType_UnknownType) \
	op(ESteamCoreNetworkingIdentityType::k_ESteamNetworkingIdentityType__Force32bit) 

enum class ESteamCoreNetworkingIdentityType : uint8;
template<> struct TIsUEnumClass<ESteamCoreNetworkingIdentityType> { enum { Value = true }; };
