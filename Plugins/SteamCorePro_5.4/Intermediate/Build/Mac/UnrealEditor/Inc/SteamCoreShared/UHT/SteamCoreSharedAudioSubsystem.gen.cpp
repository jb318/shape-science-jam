...
struct Z_Construct_UClass_USteamCoreAudioCaptureBlueprintLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreAudioCaptureBlueprintLibrary_Conv_AudioInputDeviceInfoToString, "Conv_AudioInputDeviceInfoToString" }, // 854066548
		{ &Z_Construct_UFunction_USteamCoreAudioCaptureBlueprintLibrary_GetAvailableAudioInputDevices, "GetAvailableAudioInputDevices" }, // 938876759
	};
...
struct Z_Construct_UClass_USteamCoreSharedAudioSubsystem_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_USteamCoreSharedAudioSubsystem_K2_FindAudioDeviceInfoFromDeviceId, "K2_FindAudioDeviceInfoFromDeviceId" }, // 3343413592
		{ &Z_Construct_UFunction_USteamCoreSharedAudioSubsystem_K2_FindAudioDeviceInfoFromDeviceName, "K2_FindAudioDeviceInfoFromDeviceName" }, // 1322365711
		{ &Z_Construct_UFunction_USteamCoreSharedAudioSubsystem_K2_GetAudioInputDevices, "K2_GetAudioInputDevices" }, // 1956214181
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCoreShared_Public_SteamCoreSharedAudioSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USteamCoreAudioCaptureBlueprintLibrary, USteamCoreAudioCaptureBlueprintLibrary::StaticClass, TEXT("USteamCoreAudioCaptureBlueprintLibrary"), &Z_Registration_Info_UClass_USteamCoreAudioCaptureBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreAudioCaptureBlueprintLibrary), 3102772079U) },
		{ Z_Construct_UClass_USteamCoreSharedAudioSubsystem, USteamCoreSharedAudioSubsystem::StaticClass, TEXT("USteamCoreSharedAudioSubsystem"), &Z_Registration_Info_UClass_USteamCoreSharedAudioSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USteamCoreSharedAudioSubsystem), 2881728436U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCoreShared_Public_SteamCoreSharedAudioSubsystem_h_1147031000(TEXT("/Script/SteamCoreShared"),
	Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCoreShared_Public_SteamCoreSharedAudioSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_SteamCorePro_Source_SteamCoreShared_Public_SteamCoreSharedAudioSubsystem_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
